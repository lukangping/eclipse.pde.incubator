...
/**
 * This is the item provider adapter for a {@link org.eclipse.pde.ds.scr.Provide} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProvideItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Provide_interface_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Provide_interface_feature", "_UI_Provide_type"),
				 ScrPackage.Literals.PROVIDE__INTERFACE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Class labelValue = ((Provide)object).getInterface();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Provide.class)) {
