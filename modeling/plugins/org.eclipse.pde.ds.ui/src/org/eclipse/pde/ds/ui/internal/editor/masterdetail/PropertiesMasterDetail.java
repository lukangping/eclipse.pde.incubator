 ...
 *
 * $Id: PropertiesMasterDetail.java,v 1.18 2009/12/02 11:35:15 bcabe Exp $
 */
...
public class PropertiesMasterDetail extends EmfMasterDetailBlock {
	...
	public PropertiesMasterDetail(EmfFormEditor<?> editor) {
		super(editor, "Properties", EmfMasterDetailBlock.USE_CUSTOM_PUSH_BUTTONS | USE_GENERIC_TOOLBAR_BUTTONS);
	}
