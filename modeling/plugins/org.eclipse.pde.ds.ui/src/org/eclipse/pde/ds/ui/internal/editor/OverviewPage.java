...
public class OverviewPage extends AbstractEmfFormPage {
	...
	protected void bind(DataBindingContext bindingContext) {
		EditingDomain editingDomain = ((DSEditor) getEditor())
				.getEditingDomain();
		 ...
		 */
		// component name
		bindingContext.bindValue(WidgetProperties.text(SWT.FocusOut).observe(
				_componentComposite.getTextName()), EMFEditObservables
				.observeDetailValue(Realm.getDefault(), editingDomain,
						getObservedValue(), ScrPackage.eINSTANCE
								.getComponent_Name()), null, null);
		// component impl
		IObservableValue implementationObservable = EMFEditObservables
				.observeDetailValue(Realm.getDefault(), editingDomain,
						getObservedValue(), ScrPackage.eINSTANCE
								.getComponent_Implementation());
		bindingContext.bindValue(WidgetProperties.text(SWT.FocusOut).observe(
				_componentComposite.getTextImplementation()),
				EMFEditObservables.observeDetailValue(Realm.getDefault(),
						editingDomain, implementationObservable,
						ScrPackage.eINSTANCE.getImplementation_Class()), null,
				null);
		...
		bindingContext.bindValue(WidgetProperties.text(SWT.FocusOut).observe(
				_optionsComposite.getTextFactory()), EMFEditObservables
				.observeDetailValue(Realm.getDefault(), editingDomain,
						getObservedValue(), ScrPackage.eINSTANCE
								.getComponent_Factory()), null, null);
		// component configuration policy
		bindingContext.bindValue(ViewerProperties.singleSelection().observe(
				_optionsComposite.getComboViewerConfigurationPolicy()),
				EMFEditObservables.observeDetailValue(Realm.getDefault(),
						editingDomain, getObservedValue(), ScrPackage.eINSTANCE
								.getComponent_ConfigurationPolicy()), null,
				null);
		// component enablement
		bindingContext.bindValue(WidgetProperties.selection().observe(
				_optionsComposite.getButtonEnabled()), EMFEditObservables
				.observeDetailValue(Realm.getDefault(), editingDomain,
						getObservedValue(), ScrPackage.eINSTANCE
								.getComponent_Enabled()), null, null);
		// component immediacy
		bindingContext.bindValue(WidgetProperties.selection().observe(
				_optionsComposite.getButtonImmediate()), EMFEditObservables
				.observeDetailValue(Realm.getDefault(), editingDomain,
						getObservedValue(), ScrPackage.eINSTANCE
								.getComponent_Immediate()), null, null);
	}
	...
	private void addToolbarActions() {
		IToolBarManager toolBarManager = getManagedForm().getForm()
				.getToolBarManager();
	...
	private void createComponentSection(Composite parent) {
		Section s = getFormToolkit().createSection(parent,
