...
public class GoogleSearchLinkManager {
	...
	private EclipseLinkObject fGoogleSearchLink;
	 ...
	 * @return
	 */
	public static EclipseLinkObject getGoogleSearchLink(EclipseLinkModel model, String searchText) {
	 ...
	 * @return
	 */
	public EclipseLinkObject createGoogleSearchLink(EclipseLinkModel model, String searchText) {
